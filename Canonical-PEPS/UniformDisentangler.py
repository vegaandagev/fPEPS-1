...
##########################################
 ...
 N_ten.permute([-20,-40,-10,-30],2)
 val_cond=1.0
 #val_cond=condition_number(N_ten)
 #print val_cond
...
# print val2
 ...
 return PEPS_1, PEPS_2, h_h[0]/Norm_h[0], val_cond
...
#@profile
def  Update_E_H(PEPS_f, PEPS_s, U_ham,U_ham0,U_hamN, Location, N_x, D, d,N_y, H, H0, HN,chi_express, cond_list):
...
#   PEPS_f_conj.setLabel([30,-8,6,7,-5])
 ...
 for i in xrange(len(E_list_left)):
  #print "i", i
  PEPS_su[i], PEPS_fu[i], E_val, val_cond=update_twotensor(PEPS_s, PEPS_f,E_list_left,E_list_right,i,Ham, D,H_orig)
  E_row.append(E_val)
  cond_list.append(val_cond)
 ...
 return  PEPS_fu,PEPS_su, E_coulmn, E_row#, PEPS_simplef, PEPS_simples
