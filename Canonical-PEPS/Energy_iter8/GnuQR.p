...
p [0:50] [-3.65:-3.50] "EnergyIter.txt" u ($1):($2)  t "D=2, D_c=2" with points  pointtype 11 lw 3  ps 4.0 lc rgb "#cc0000","EnergyIter1.txt" u ($1):($2)  t "D=2, D_c=4" with points  pointtype 13 lw 3  ps 4.0 lc rgb "#204a87", "EnergyIterD3.txt" u ($1):($2) t "D=3, D_c=3" with points  pointtype 17 lw 3  ps 4.0 lc rgb "#8A2BE2","EnergyIterD31.txt" u ($1):($2)  t "D=3, D_c=6" with points  pointtype 19 lw 3  ps 4.0 lc rgb "#fdc328","EnergyIterD4.txt" u ($1):($2)  t "D=4, D_c=4" with points  pointtype 6 lw 3  ps 4.0 lc rgb "#5cc863","EnergyIterD42.txt" u ($1):($2)  t "D=4, D_c=8" with points  pointtype 2 lw 3  ps 4.0 lc rgb "#440154", -3.6350  t "DMRG" with line lw 4 linetype 7 lc rgb "#204a87"
