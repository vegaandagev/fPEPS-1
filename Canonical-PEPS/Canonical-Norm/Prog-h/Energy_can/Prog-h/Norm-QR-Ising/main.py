...
def QR_function(a_u,b_u,c_u,d_u):
 ...
 #########################Ising###################################################
 #a_ising=uni10.UniTensor("test_tensors/isingTensorD2h35.dat")
 #a_ising=uni10.UniTensor("test_tensors/isingTensorD3h35.dat")
 #a_ising=uni10.UniTensor("test_tensors/isingTensorD4h35.dat")

 #a_ising=uni10.UniTensor("test_tensors/IsingGamma_aD2")
 #a_ising1=uni10.UniTensor("test_tensors/IsingGamma_bD2")

 #a_ising=uni10.UniTensor("test_tensors/IsingGamma_aD3")
 #a_ising1=uni10.UniTensor("test_tensors/IsingGamma_bD3")

 #a_ising=uni10.UniTensor("test_tensors/IsingGamma_aD4")
 #a_ising1=uni10.UniTensor("test_tensors/IsingGamma_bD4")


 #a_ising=uni10.UniTensor("test_tensors/HGamma_aD4")
 #a_ising1=uni10.UniTensor("test_tensors/HGamma_cD4")

 #a_ising=uni10.UniTensor("test_tensors/D2a_u")
 #a_ising1=uni10.UniTensor("test_tensors/D2c_u")

 #a_ising=uni10.UniTensor("test_tensors/D4a_u")
 #a_ising1=uni10.UniTensor("test_tensors/D4c_u")

 #a_ising=uni10.UniTensor("test_tensors/D5a_u")
 #a_ising1=uni10.UniTensor("test_tensors/D5c_u")
 ...
 #a_ising=uni10.UniTensor("test_tensors/IsingD3a_u")
 #a_ising1=uni10.UniTensor("test_tensors/IsingD3c_u")

 #a_ising=uni10.UniTensor("test_tensors/IsingD2a_u")
 #a_ising1=uni10.UniTensor("test_tensors/IsingD2c_u")

 a_ising=a_u#uni10.UniTensor("test_tensors/IsingD4a_u")
 a_ising1=c_u#uni10.UniTensor("test_tensors/IsingD4c_u")

 #a_ising=uni10.UniTensor("test_tensors/a_u")
 #a_ising1=uni10.UniTensor("test_tensors/c_u")
