...
p [0:120]  "D2N4Norm.txt" u ($1):($2)  t "D=2, 44, {/Symbol c}=4" with points  pointtype 11 lw 3  ps 8.0 lc rgb "#cc0000","D2N8Norm.txt" u ($1):($2)  t "D=2, 88, {/Symbol c}=4" with points  pointtype 13 lw 3  ps 8.0 lc rgb "#204a87"


#, "EnergyIterD3.txt" u ($1):($2)  t "D=3, {/Symbol c}=3" with points  pointtype 15 lw 3  ps 8.0 lc rgb "#fdc328","EnergyIterD31.txt" u ($1):($2)  t "D=3, {/Symbol c}=6" with points  pointtype 17 lw 3  ps 8.0 lc rgb "#a82296", -3.6140  t "DMRG" with line lw 4 linetype 7 lc rgb "#204a87"
