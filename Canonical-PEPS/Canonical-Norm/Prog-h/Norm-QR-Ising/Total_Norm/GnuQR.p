...
set key at 0, -6
set output "QR.eps"
p [-10:10]   "D3NormN16.txt" u ($1-8):(log(abs($2-$3)*0.006/($2))/log(10))  t "{/Symbol l}=2.00, l=2" with points  pointtype 9 lw 3  ps 8.0 lc rgb "#a40000","D3NormN16.txt" u ($1-8):(log(abs($2-$3)*0.5/($2))/log(10))  t "{/Symbol l}=3.05, l=2" with points  pointtype 11 lw 3  ps 8.0 lc rgb "#5c3566","h3D3NormN16.txt" u ($1-8):(log(abs($2-$3)/($2))/log(10))  t "{/Symbol l}=3.05, l=4" with points  pointtype 13 lw 3  ps 8.0 lc rgb "#ce5c00","h3D3NormN16.txt" u ($1-8):(log(abs($2-$3)*0.0007/($2))/log(10))  t "{/Symbol l}=2.00, l=4" with points  pointtype 15 lw 3  ps 8.0 lc rgb "#cd5c5c"
