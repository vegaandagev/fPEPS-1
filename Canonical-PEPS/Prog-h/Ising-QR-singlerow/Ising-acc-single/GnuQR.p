...
set ytics nomirror ("10^{-5}" -5, "10^{-6}"-6, "10^{-7}" -7, "10^{-8}" -8, "10^{-9}" -9, "10^{-10}" -10, "10^{-11}" -11, "10^{-12}" -12,"10^{-13}" -13 );
set tics scale 4
...
p  [0.05:6] "D2accIsingN16.txt" u ($1):(log(1-abs($2))/log(10))  t "D=2, l=2" with points  pointtype 13 lw 3  ps 4.0 lc rgb "#a40000","l4D2accIsingN16.txt" u ($1):(log(1-abs($2))/log(10))  t "D=2, l=4" with points  pointtype 7 lw 3  ps 4.0 lc rgb "#f57900","l4D4accIsingN16.txt" u ($1):(log(1-abs($2))/log(10))  t "D=4, l=4" with points  pointtype 9 lw 3  ps 4.0 lc rgb "#c71585","D4accIsingN16.txt" u ($1):(log(1-abs($2))/log(10))  t "D=4, l=2" with points  pointtype 11 lw 3  ps 4.0 lc rgb "#cc0000"
