...
set output "QR.eps"
p [0:100]  "QRD3.txt" u ($1):(log(1-abs($2))/log(10))  t "D=3" with points  pointtype 7 lw 3  ps 8.0 lc rgb "#DC143C", "QRD4.txt" u ($1):(log(1-abs($2))/log(10))  t "D=4" with points  pointtype 13 lw 3  ps 8.0 lc rgb "#C71585", "QRD5.txt" u ($1):(log(1-abs($2))/log(10))  t "D=5" with points  pointtype 15 lw 3  ps 8.0 lc rgb "#fdc328"
