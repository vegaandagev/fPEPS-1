...
#p  "D3.txt" u ($1):(0.5*log(1-abs($2)))  t "D=3, l=2" with points  pointtype 9 lw 3  ps 8.0 lc rgb "#DC143C", "D3.txt" u ($1):(0.5*log(1-abs($3)))  t "D=3, l=4" with points  pointtype 17 lw 3  ps 8.0 lc rgb "#C71585","D3.txt" u ($1):(0.5*log(1-abs($5)))  t "D=4, l=2" with points  pointtype 15 lw 3  ps 8.0 lc rgb "#204a87","D3.txt" u ($1):(log(1-abs($4)))  t "D=4, l=4" with points  pointtype 9 lw 3  ps 8.0 lc rgb "#f57900"

p [4:30]  "D2.txt" u ($1):((1-abs($2)))  t "D=2, l=2" with points  pointtype 11 lw 3  ps 8.0 lc rgb "#cc0000", "D2.txt" u ($1):((1-abs($3)))  t "D=2, l=4" with points  pointtype 9 lw 3  ps 8.0 lc rgb "#c71585","D3.txt" u ($1):((1-abs($2))*0.5)  t "D=3, l=2" with points  pointtype 13 lw 3  ps 8.0 lc rgb "#f57900", "D3.txt" u ($1):((1-abs($3)))  t "D=3, l=4" with points  pointtype 15 lw 3  ps 8.0 lc rgb "#5cc863"
