...
def Heisenberg0(h, d_phys):
    ...
    #ham =uni10.otimes(sz,sz)*(-1)+(-0.2500)*float(h[0])*(uni10.otimes(iden,sx)+uni10.otimes(sx,iden))
...
############################################################################
 E_1=Energy_h(a_u,b_u,a,b,c,d,Env,D,h,d_phys,chi,Corner_method,Model,N_env)
 #print "E_val1", E_val1

 E_2=Energy_h(b_u,a_u,b,a,d,c,Env1,D,h,d_phys,chi,Corner_method,Model,N_env)
 #print "E_val2", E_val2

 E_3=Energy_h(c_u,d_u,c,d,a,b,Env2,D,h,d_phys,chi,Corner_method,Model,N_env)
 #print "E_val3", E_val3

 E_4=Energy_h(d_u,c_u,d,c,b,a,Env3,D,h,d_phys,chi,Corner_method,Model,N_env)
 #print "E_val4", E_val4


 E_5=Energy_v(c_u,a_u,a,b,c,d,Env,D,h,d_phys,chi,Corner_method,Model,N_env)
 #print "E_val4", E_val4
 
 E_6=Energy_v(a_u,c_u,c,d,a,b,Env2,D,h,d_phys,chi,Corner_method,Model,N_env)
 #print "E_val5", E_val5

 E_7=Energy_v(d_u,b_u,b,a,d,c,Env1,D,h,d_phys,chi,Corner_method,Model,N_env)
 #print "E_val6", E_val6

 E_8=Energy_v(b_u,d_u,d,c,b,a,Env3,D,h,d_phys,chi,Corner_method,Model,N_env)
 #print "E_val7", E_val7
...
def Energy_h(a_u,b_u,a,b,c,d,Env,D,h,d_phys,chi,Corner_method,Model,N_env):
 ...
 if Corner_method is 'CTMFull':
  c1, c2,c3,c4,Ta1, Tb1,Ta2, Tb2,Ta3, Tb3,Ta4, Tb4=corner_transfer_matrix_twosite_CTMFull(a_u,b_u,copy.copy(a_u),copy.copy(b_u),a,b,c,d,chi,c1, c2,c3,c4,Ta1, Tb1,Ta2, Tb2,Ta3, Tb3,Ta4, Tb4,D,H0,d_phys,'h',N_env)
  #Store_Env(c1,c2,c3,c4, Ta1, Ta2, Ta3, Ta4, Tb1, Tb2, Tb3, Tb4) 
