...
set output "QR.eps"
p  "D3NormN12.txt" u ($1-6):(log(abs($2-$3)/($2))/log(10))  t "D=3, l=2, 12{/Symbol \264}12" with points  pointtype 11 lw 3  ps 8.0 lc rgb "#5c3566","ACCD3NormN12.txt" u ($1-6):(log(abs($2-$3)/($2))/log(10))  t "D=3, l=4, 12{/Symbol \264}12" with points  pointtype 15 lw 3  ps 8.0 lc rgb "#cc0000","D3NormN16.txt" u ($1-8):(log(abs($2-$3)/($2))/log(10))  t "D=3, l=2, 16{/Symbol \264}16" with points  pointtype 7 lw 3  ps 8.0 lc rgb "#ce5c00","ACCD3NormN16.txt" u ($1-8):(log(abs($2-$3)*0.5/($2))/log(10))  t "D=3, l=4, 16{/Symbol \264}16" with points  pointtype 19 lw 3  ps 8.0 lc rgb "#cd5c5c"
