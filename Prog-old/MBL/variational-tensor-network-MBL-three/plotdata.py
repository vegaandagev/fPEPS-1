...
def Store(variance_final1, variance_final2,variance_final3,variance_final4,q,L, file, Count_final1, Count_final2, Count_final3, Count_final4,time1, time2, time3, time4,time_final1,time_final2,time_final3,time_final4):
...
# var4=sum(variance_final4)/len(variance_final4)
 time11=sum(time_final1)/len(time_final1)
 time22=sum(time_final2)/len(time_final2)
 time33=sum(time_final3)/len(time_final3)


 
 file.write (str(q)  + " " + str(variance_final1[Length]) + " " + str(variance_final2[Length2]) +  " "+str(variance_final3[Length3])+" "+ str(var1)+" "+ str(var2) +" "+ str(var3)+" "+ str(Count_final1[Length11])+ " "+ str(Count_final2[Length22])+" "+str(Count_final3[Length33])+" "+str(time1[len(time1)-1]) + " "+ str(time2[len(time2)-1])+ " "+ str(time3[len(time3)-1]) +"  "+str(time11)+"  "+str(time22)+"  "+str(time33)+"\n" )
 file.flush()
