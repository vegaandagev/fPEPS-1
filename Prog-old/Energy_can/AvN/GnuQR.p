...
p  "D3.txt" u ($1):(1-abs($5))  t "D=4, l=2" with points  pointtype 11 lw 3  ps 8.0 lc rgb "#cc0000","D3.txt" u ($1):((1-abs($4)))  t "D=4, l=4" with points  pointtype 9 lw 3  ps 8.0 lc rgb "#c71585"
