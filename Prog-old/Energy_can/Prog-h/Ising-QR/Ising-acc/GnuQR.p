...
p [1:6]  "D2accIsingN12.txt" u ($1):(log(abs($2))/log(10))  t "D=2, l=2, 12{/Symbol \264}12" with points  pointtype 15 lw 3  ps 8.0 lc rgb "#ce5c00","l4D2accIsingN12.txt" u ($1):(log(abs($2))/log(10))  t "D=2, l=4, 12{/Symbol \264}12" with points  pointtype 15 lw 3  ps 8.0 lc rgb "#a40000","l4D3accIsingN12.txt" u ($1):(log(abs($2))/log(10))  t "D=3, l=4, 12{/Symbol \264}12" with points  pointtype 19 lw 3  ps 8.0 lc rgb "#ff1493","D2accIsingN8.txt" u ($1):(log(abs($2))/log(10))  t "D=2, l=2, 8{/Symbol \264}8" with points  pointtype 17 lw 3  ps 8.0 lc rgb "#C71585","l4D2accIsingN8.txt" u ($1):(log(abs($2))/log(10))  t "D=2, l=4, 8{/Symbol \264}8" with points  pointtype 17 lw 3  ps 8.0 lc rgb "#204a87", "D3accIsingN12.txt" u ($1):(log(abs($2))/log(10))  t "D=3, l=2, 12{/Symbol \264}12" with points  pointtype 3 lw 3  ps 8.0 lc rgb "#8f5902"
