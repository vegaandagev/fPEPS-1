...
p [0:50] [-3.66:-3.51] "EnergyIter.txt" u ($1):($2)  t "D=2, {/Symbol c}=2" with points  pointtype 11 lw 3  ps 8.0 lc rgb "#cc0000","EnergyIter1.txt" u ($1):($2)  t "D=2, {/Symbol c}=4" with points  pointtype 13 lw 3  ps 8.0 lc rgb "#204a87", "EnergyIter2.txt" u ($1):($2)  t "D=2, {/Symbol c}=6" with points  pointtype 15 lw 3  ps 8.0 lc rgb "#fdc328", "EnergyIterD3.txt" u ($1):($2)  t "D=3, {/Symbol c}=3" with points  pointtype 17 lw 3  ps 8.0 lc rgb "#8A2BE2","EnergyIterD31.txt" u ($1):($2)  t "D=3, {/Symbol c}=6" with points  pointtype 19 lw 3  ps 8.0 lc rgb "#ce5c00", -3.6350  t "DMRG" with line lw 4 linetype 7 lc rgb "#204a87"
