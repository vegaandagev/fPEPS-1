...
set output "ES2.eps"
p    "Spectrum4.txt"  u 1:2 t "S_{z}=4"   with points  pointtype 6 lw 2 ps 3.0 lc rgb "#4169E1",   "Spectrum2.txt" u 1:2 t "S_{z}=2"  with points  pointtype 6 lw 2  ps 6.0 lc rgb "#FF1493", "Spectrum.txt" u 1:2 t "S_{z}=0"  with points  pointtype 2 lw 2  ps 3.0 lc rgb "#8B008B"
