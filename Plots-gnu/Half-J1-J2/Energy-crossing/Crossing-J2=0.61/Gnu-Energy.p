...
set ytics nomirror (-0.471,-0.48,-0.475, -0.477,-0.473);
...
p [0.0:0.35] [-0.4790:-0.4680]   "J20.61.txt"  title 'VBS' with linespoints lt 4 dt 4 lw 3 pt 2 ps 8  lc rgb "#FF1493", "J20.61.txt" u ($1):($3) title 'Stripe' with linespoints lt 4 dt 4 lw 3 pt 14 ps 8  lc rgb "#008080"
