...
p  [0.0:10]   "CorrelationH5.txt"   t 'D=5'  with points  pointtype 2 lw 3  ps 5.0 lc rgb "#3CB371","CorrelationH6.txt"   t 'D=6'  with points  pointtype 4 lw 3  ps 5.0 lc rgb "#3CB371", "CorrelationH7.txt" t 'D=7' with points  pointtype 10 lw 3  ps 5.0 lc rgb "#6495ED", "CorrelationV5.txt" t 'D=5'  with points  pointtype 2 lw 3  ps 5.0 lc rgb "red","CorrelationV6.txt" t 'D=6'  with points  pointtype 4 lw 3  ps 5.0 lc rgb "red", "CorrelationV7.txt"  t 'D=7' with points  pointtype 10 lw 3  ps 5.0 lc rgb "red"
