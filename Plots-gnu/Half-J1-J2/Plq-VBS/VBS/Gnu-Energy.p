...
set output "plq-VBS.eps"
p [0.0:0.35]    "J20.6.txt"  title 'VBS' with linespoints lt 4 dt 4 lw 3 pt 2 ps 8  lc rgb "#FF1493", "J20.6.txt" u ($1):($3) title 'Stripe' with linespoints lt 4 dt 4 lw 3 pt 14 ps 8  lc rgb "#008080"
