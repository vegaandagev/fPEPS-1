...
p  [3.5:8.5] [0.9:2] "L1.txt" u  ($1):($2) t "spin-spin"   with  points  pointtype 2 lw 3  ps 8.0 lc rgb "#FF1493", M(x) notitle with line dt 4 lw 4 linetype 4 lc rgb "#8A2BE2"

#, M2(x) notitle with line dt 4 lw 4 linetype 4 lc rgb "#483D8B",M3(x) notitle with line dt 4 lw 4 linetype 4 lc rgb "#6A5ACD"
