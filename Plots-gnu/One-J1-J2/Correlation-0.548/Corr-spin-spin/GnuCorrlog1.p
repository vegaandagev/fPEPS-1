...
M4(x)=c4* exp(-x*d4)
fit  [15:40] M4(x) "CorrelationH4.txt" u ($1):(abs($2))    via c4,d4 

M5(x)=c5* exp(-x*d5)
fit  [15:40] M5(x) "CorrelationH5.txt" u ($1):(abs($2))    via c5,d5 

M6(x)=c6*exp(-x*d6)
fit  [15:40] M6(x) "CorrelationH6.txt" u ($1):(abs($2))    via c6,d6 

M7(x)=c7*exp(-x*d7)
fit  [15:40] M7(x) "CorrelationH7.txt" u ($1):(abs($2))   via c7,d7 


M8(x)=c8*exp(-x*d8)
fit  [15:40] M8(x) "CorrelationH8.txt" u ($1):(abs($2))    via c8,d8 
