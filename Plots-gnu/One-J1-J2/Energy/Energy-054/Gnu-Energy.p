...
fit  [0.10:0.32] P(x) "ipeps.txt" u ($1):($3)    via a1,b1,c1
...
p [0.0:0.40]    x<0.330 ? G(x) : 1/0 notitle lw 4 lc rgb "#1E90FF" dt 4,x<0.330 ? P(x) : 1/0 notitle lw 4 lc rgb "#1E90FF" dt 4,   "ipeps.txt" u ($1):($2)  t 'Stripe' with points  pointtype 2 lw 3  ps 8.0 lc rgb "#8B008B", "ipeps.txt" u ($1):($3)  t 'Neel' with points  pointtype 4 lw 3  ps 8.0 lc rgb "#6A5ACD"
