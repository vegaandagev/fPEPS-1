...
G(x)=a+b*(x**(1))+c*(x**(4))
fit [0.10:0.32]  G(x) "ipeps.txt" u ($1):($4)    via a,b,c
M(x)=a1+b1*(x)
fit [0.10:0.32]  M(x) "ipeps.txt" u ($1):($4)    via a1,b1#,c
M1(x)=a2+b2*(x)
fit [0.10:0.32]  M1(x) "ipeps.txt" u ($1):($5)    via a2,b2
