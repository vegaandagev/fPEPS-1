...
M4(x)=c4*exp(-x*d4)
fit  [20:60] M4(x) "CorrelationH.txt" u ($1):(abs($2))    via c4,d4 

#M5(x)=c5* exp(-x*d5)
#fit  [15:40] M5(x) "CorrelationH6.txt" u ($1):(abs($2))    via c5,d5 
