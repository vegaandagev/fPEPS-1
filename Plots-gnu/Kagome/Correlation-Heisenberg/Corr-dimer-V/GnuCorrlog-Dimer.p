...
p  [2.0:25]  "CorrelationVV5.txt"  u ($1):(abs($2)) t 'D=5'   with points  pointtype 2 lw 3  ps 5.0 lc rgb "#4682B4", "CorrelationVV6.txt"  u ($1):(abs($2)) t 'D=6' with points  pointtype 4 lw 3  ps 5.0 lc rgb "#3CB371", "CorrelationVV7.txt"  u ($1):(abs($2)) t "D=7" with points  pointtype 10 lw 3  ps 5.0 lc rgb "#6495ED","CorrelationVV8.txt"  u ($1):(abs($2)) t "D=8" with points  pointtype 12 lw 3  ps 5.0 lc rgb "#FF6347","CorrelationINF.txt"  u ($1):(abs($2)) t 'D {/Symbol \256 } {/Symbol \245 }' with points  pointtype 14 lw 3  ps 5.0 lc rgb "#9400D3",  M(x) t 'r^{-2.9}' with line dt 4 lw 4 linetype 4 lc rgb "blue"
