...
p [0.0:1.0]    "J20.5.txt" u ($1):($2)  t "D=4" with points  pointtype 2 lw 3  ps 8.0 lc rgb "#8B008B", "J20.5.txt" u ($1):($3)  t "D=5" with points  pointtype 6 lw 3  ps 8.0 lc rgb "#1E90FF","J20.5.txt" u ($1):($4)  t "D=6" with points  pointtype 4 lw 3  ps 8.0 lc rgb "#FF1493", "chiral7.txt" u ($1):($2)  t "D=7" with points  pointtype 10 lw 3  ps 8.0 lc rgb "#2F4F4F"
