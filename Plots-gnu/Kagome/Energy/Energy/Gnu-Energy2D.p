...
set ylabel "{/Symbol \266}^{2}E/{/Symbol \266}J_{chiral}"  font ",40"  textcolor rgb "black"
...
set output "E-2D.eps"
p [-0.4:0.4]  [0:0.6]  "Der4.txt" u ($1):(abs($3))  t "D=5" with points  pointtype 2 lw 3  ps 8.0 lc rgb "#8B008B","Der6.txt" u ($1):(abs($3))  t "D=6" with points  pointtype 4 lw 3  ps 8.0 lc rgb "#FF1493","Der7.txt" u ($1):(abs($3))  t "D=7" with points  pointtype 10 lw 3  ps 8.0 lc rgb "#2F4F4F"
