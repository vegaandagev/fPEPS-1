...
p [0.0:0.50]    -0.541 t "DMRG" with line lw 4 linetype 4, x<0.335 ? G(x) : 1/0 notitle lw 4 lc rgb "#1E90FF" dt 4,  "J20.5.txt"  notitle with points  pointtype 2 lw 3  ps 8.0 lc rgb "#8B008B"

#-0.4958 t "Cluster PEPS" with line lw 4 linetype 6,
#  x<0.27 ? M(x) : 1/0 notitle lw 4 lc rgb "blue" dt 4,
