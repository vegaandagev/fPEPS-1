...
set xtics nomirror (2,4,6,8,10,12)
...
P(x)=b2*(x**c2)
fit P(x) "Echiral.txt" u (1/$1):($4)    via b2,c2
...
p   [0.0:14]   "Echiral.txt"  u (1/$1):($4)  t "{/Symbol x}:uniform"  with points  pointtype 2 lw 3  ps 8.0 lc rgb "#a40000", x<13 ? P(x) : 1/0 notitle lw 4 lc rgb "#729fcf" dt 4
