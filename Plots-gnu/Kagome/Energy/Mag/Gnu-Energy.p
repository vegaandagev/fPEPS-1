...
p [-0.7:0.7] [0.0:0.114]   "M5.txt" u ($1):($2)  t "D=5" with points  pointtype 2 lw 3  ps 8.0 lc rgb "#8B008B", "M7.txt" u ($1):($2)  t "D=7" with points  pointtype 6 lw 3  ps 8.0 lc rgb "#1E90FF","M9.txt" u ($1):($2)  t "D=9" with points  pointtype 4 lw 3  ps 8.0 lc rgb "#FF1493","M11.txt" u ($1):($2)  t "D=11" with points  pointtype 10 lw 3  ps 8.0 lc rgb "#2F4F4F"
