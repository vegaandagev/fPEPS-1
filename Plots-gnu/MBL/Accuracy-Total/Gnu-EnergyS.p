...
set output "Cost.eps"
p [1:10]  [0.01:1]   "varianceAll.txt"  u ($1):($2) t "Binary" with points lw 3 lt rgb "#FF1493" pointtype 2  ps 8,"varianceAll.txt"  u ($1):($3) t "Wahl:l=4" with points lw 3 lt rgb "#9400D3" pointtype 4  ps 8, "varianceAll.txt"  u ($1):($4) t "Pollmann" with points lw 3 lt rgb "#FFA500" pointtype 6  ps 8, "varianceAll.txt"  u ($1):($5) t "Wahl:l=6" with points lw 3 lt rgb "#DC143C" pointtype 8  ps 8, "varianceAll.txt"  u ($1):($6) t "Ternary" with points lw 3 lt rgb "#A0522D" pointtype 12  ps 8
