...
set output "Cost.eps"
p [100:1000000] [0.25:13]  "varianceM_0.txt"  u ($1):($2) t "Linearizing" with points lw 3 lt rgb "#FF0000" pointtype 2  ps 6, "varianceM1_0.txt" u ($1):($2) t "CG-Poly" with points lw 3 pointtype 4  ps 6  lt rgb "#FF1493" ,"varianceM4_0.txt" u ($1):($2) t "SD-Poly" with points lw 3 pointtype 5  ps 6 lt rgb "#FF69B4","varianceM2_0.txt" u ($1):($2) t "CG-Armji" with points lw 3 pointtype 8  ps 6 lt rgb "#6A5ACD" , "varianceM3_0.txt" u ($1):($2) t "SD-Armji" with points lw 3 pointtype 10  ps 6 lt rgb "#4682B4"
