...
set output "Cost.eps"
p [100:60000] [0.07:8]  "varianceSVD_0.txt"  u ($1):($2) t "Linearizing" with points lw 3 lt rgb "#FF0000" pointtype 2  ps 6, "variancePol_0.txt" u ($1):($2) t "CG-Poly" with points lw 3 pointtype 4  ps 6  lt rgb "#FF1493","varianceArm_0.txt" u ($1):($2) t "CG-Armji" with points lw 3 pointtype 8  ps 6 lt rgb "#6A5ACD" 
