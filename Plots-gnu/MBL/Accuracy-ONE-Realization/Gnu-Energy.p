...
set key spacing 8
set output "Cost.eps"
p [20:60000] [0.02:4]   "varianceM1_0.txt" u ($1):($2) t "Ternary" with points lw 3 pointtype 4  ps 6.0  lt rgb "#2E8B57" ,"varianceM2_0.txt" u ($1):($2) t "Binary" with points lw 3 pointtype 6  ps 6.0 lt rgb "#FF1493" , "varianceR_0.txt" u ($1):($2) t "Regular" with points lw 3 pointtype 8  ps 6.0 lt rgb "#DC143C"
