...
set xlabel "Layer"   font ",35" textcolor rgb "black"
...
p [0.5:6] [4:2000000] "time.txt"  u ($1):($2)*(10000) t "Linearizing" with linespoints lw 2.5 lt rgb "#EE82EE" pointtype 4  ps 8, "time.txt"  u ($1):($3)*(10000) t "CG-Armji" with linespoints lw 2.5 lt rgb "#6A5ACD" pointtype 8  ps 8
