...
p  "ED4.txt" u  ($1):(log((abs((($2)+0.658504424)/0.65850442497)))/log(10))  t "D=4, V=0.1, U(1), D"  with  points  pointtype  5  lw 3  ps 4.0 lc rgb "#cc0000","ED4.txt" u  ($1):(log((abs((($3)+0.658504424)/0.65850442497)))/log(10))  t "D=4, V=0.1, U(1), S"  with  points  pointtype  7  lw 3  ps 4.0 lc rgb "#ce5c00","ED5.txt" u  ($1):(log((abs((($2)+0.663703025931)/0.663703025931)))/log(10))  t "D=5, V=0.1, U(1), D"  with  points  pointtype  9  lw 3  ps 4.0 lc rgb "#a40000","ED5.txt" u  ($1):(log((abs((($3)+0.663703025931)/0.663703025931)))/log(10))  t "D=5, V=0.1, U(1), S"  with  points  pointtype  11  lw 3  ps 4.0 lc rgb "#c4a000"
